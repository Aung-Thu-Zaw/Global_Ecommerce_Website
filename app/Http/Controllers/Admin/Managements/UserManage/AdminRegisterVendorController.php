...
class AdminRegisterVendorController extends Controller
{
    ...
    public function show(User $user): Response|ResponseFactory
    {
        ...
        return inertia("Admin/Managements/UserManage/RegisterVendors/Details", compact("user", "paginate"));
    }
    ...
    public function trash(): Response|ResponseFactory
    {
        ...
        return inertia("Admin/Managements/UserManage/RegisterVendors/Trash", compact("trashVendors"));
    }
