...
class ThankForWebsiteFeedbackMail extends Mailable
{
    use Queueable;
    ...
    public function envelope()
    {
        return new Envelope(
            ...
            subject: 'Thank you for Your Website Feedback Rating',
        );
    }
    ...
    {
        return new Content(
            view: 'mails.for-submitters.thanks-for-website-feedback-mail',
        );
    }
}
