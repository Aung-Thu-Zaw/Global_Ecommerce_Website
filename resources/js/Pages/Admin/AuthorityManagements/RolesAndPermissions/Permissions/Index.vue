...
const params = reactive({
  search: null,
  page: props.permissions.current_page ? props.permissions.current_page : 1,
  per_page: props.permissions.per_page ? props.permissions.per_page : 10,
  sort: "id",
  direction: "desc",
});
    ...
    <div class="px-4 md:px-10 mx-auto w-full py-32">
      ...
      <TableContainer>
        ...
        <tbody v-if="permissions.data.length">
          <Tr v-for="permissions in permissions.data" :key="permissions.id">
            <BodyTh>{{ permissions.id }}</BodyTh>
            <Td>{{ permissions.name }}</Td>
            <Td class="capitalize">{{ permissions.group }}</Td>
            <Td>{{ permissions.created_at }}</Td>
            <Td>
              <Link
                as="button"
                :href="route('admin.permissions.edit', permissions.id)"
                :data="{
              ...
              <button
                @click="handleDelete(permissions)"
