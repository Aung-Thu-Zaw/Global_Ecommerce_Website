...
const handleLanguageRestore = async (trashLanguageId) => {
...
const handleLanguageDelete = async (trashLanguageId) => {
  const result = await swal({
    icon: "warning",
...
<template>
  <AdminDashboardLayout>
    ...
    <div class="px-4 md:px-10 mx-auto w-full py-32">
          ...
          >
            ...
            <Td v-if="languageTrashRestore || languageTrashDelete">
              <button
                ...
                @click="handleLanguageRestore(trashLanguage.id)"
              ...
              <button
                ...
                @click="handleLanguageDelete(trashLanguage.id)"
      ...
      <!-- Pagination -->
      <Pagination class="mt-6" :links="trashLanguages.links" />
    </div>
  </AdminDashboardLayout>
</template>
