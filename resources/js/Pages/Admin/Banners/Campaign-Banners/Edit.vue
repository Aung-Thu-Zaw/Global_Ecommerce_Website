...
// Campaign Banner Edit Form Data
const form = useForm({
...
// Handle Edit Campaign Banner
const handleEditCampaignBanner = async () => {
  await recaptchaLoaded();
  form.captcha_token = await executeRecaptcha("edit_campaign_banner");
...
<template>
  <AdminDashboardLayout>
    <Head :title="__('EDIT_CAMPAIGN_BANNER')" />
