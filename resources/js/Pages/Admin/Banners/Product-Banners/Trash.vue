  ...
  <AdminDashboardLayout>
    ...
    <div class="px-4 md:px-10 mx-auto w-full py-32">
      ...
      >
        ...
        days.
        <button
          @click="handlePermanentlyDeleteProductBanners"
      ...
      <TableContainer>
        ...
        <tbody v-if="trashProductBanners.data.length">
          ...
          >
            <BodyTh>
              {{ trashProductBanner.id }}
            </BodyTh>

            <Td>
              <img :src="trashProductBanner.image" class="image" />
            </Td>

            <Td>
              {{ trashProductBanner.url }}
            </Td>
      ...
      <!-- Pagination -->
      <div v-if="trashProductBanners.data.length" class="mt-6">
        <p class="text-center text-sm text-gray-600 mb-3 font-bold">
          Showing {{ trashProductBanners.from }} -
          {{ trashProductBanners.to }} of
          {{ trashProductBanners.total }}
        </p>
        <Pagination :links="trashProductBanners.links" />
      </div>
    </div>
  </AdminDashboardLayout>
</template>
