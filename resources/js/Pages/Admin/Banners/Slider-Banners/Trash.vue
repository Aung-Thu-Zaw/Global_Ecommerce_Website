...
const handleRestoreTrashSliderBanner = async (trashSliderBannerId) => {
  const result = await swal({
    icon: "question",
    title: "Are you sure you want to restore this slider banner?",
...
const handleDeleteTrashSliderBanner = async (trashSliderBannerId) => {
  const result = await swal({
    ...
    text: "Slider Banner in the trash will be permanetly deleted! You can't get it back.",
    showCancelButton: true,
...
const handlePermanentlyDeleteTrashSliderBanners = async () => {
  const result = await swal({
    icon: "question",
    title: "Are you sure you want to delete it from the trash?",
    text: "All slider banners in the trash will be permanetly deleted! You can't get it back.",
    showCancelButton: true,
    confirmButtonText: "Yes, Delete it !",
    confirmButtonColor: "#d52222",
    cancelButtonColor: "#626262",
  ...
  <AdminDashboardLayout>
    ...
    <div class="px-4 md:px-10 mx-auto w-full py-32">
      ...
      >
        ...
        <button
          @click="handlePermanentlyDeleteTrashSliderBanners"
