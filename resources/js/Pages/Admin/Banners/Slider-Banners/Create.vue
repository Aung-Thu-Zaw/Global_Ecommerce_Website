...
const handleCreateSliderBanner = async () => {
  await recaptchaLoaded();
  form.captcha_token = await executeRecaptcha("create_slider_banner");
...
<template>
  <AdminDashboardLayout>
    <Head :title="__('CREATE_SLIDER_BANNER')" />
    <div class="px-4 md:px-10 mx-auto w-full py-32">
      ...
      <div class="border shadow-md p-10">
        ...
        <form @submit.prevent="handleCreateSliderBanner">
