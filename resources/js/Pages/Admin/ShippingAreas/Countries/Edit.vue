...
const handleEditCountry = async () => {
  ...
  form.captcha_token = await executeRecaptcha("edit_country");

  processing.value = true;
  form.patch(
    route("admin.countries.update", {
      country: props.country.slug,
  ...
  <AdminDashboardLayout>
    ...
    <div class="px-4 md:px-10 mx-auto w-full py-32">
      ...
      <div class="border shadow-md p-10">
        <form @submit.prevent="handleEditCountry">
          <div class="mb-6">
            <InputLabel for="name" :value="__('COUNTRY_NAME') + ' *'" />
