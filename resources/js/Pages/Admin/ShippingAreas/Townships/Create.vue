...
const handleCreateTownship = async () => {
  await recaptchaLoaded();
  form.captcha_token = await executeRecaptcha("create_township");

  processing.value = true;

  form.post(
    route("admin.townships.store", {
      page: 1,
  ...
  <AdminDashboardLayout>
    ...
    <div class="px-4 md:px-10 mx-auto w-full py-32">
      ...
      <div class="border shadow-md p-10">
        <form @submit.prevent="handleCreateTownship">
          <div class="mb-6">
