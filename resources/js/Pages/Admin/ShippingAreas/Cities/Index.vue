...
const params = reactive({
  search: null,
  page: props.cities.current_page ? props.cities.current_page : 1,
  per_page: props.cities.per_page ? props.cities.per_page : 10,
  sort: "id",
  direction: "desc",
});
...
const handleDelete = async (city) => {
  if (city.townships.length > 0) {
    const result = await swal({
      icon: "error",
      title: "You can't delete this city because this city have townships?",
      text: "If you click 'Delete, whatever!' button townships will be automatically deleted.You will be able to restore this city in the trash!",
    ...
    if (result.isConfirmed) {
      router.delete(
        route("admin.cities.destroy", {
          city: city.slug,
          page: props.cities.current_page,
          per_page: params.per_page,
        })
      );
      setTimeout(() => {
    ...
    const result = await swal({
      ...
      text: "You will be able to restore this city in the trash!",
      showCancelButton: true,
    ...
    <div class="px-4 md:px-10 mx-auto w-full py-32">
      ...
      <TableContainer>
        <TableHeader>
          ...
          <HeaderTh> Country </HeaderTh>
          <HeaderTh> Region </HeaderTh>
        ...
        <tbody v-if="cities.data.length">
          <Tr v-for="city in cities.data" :key="city.id">
            ...
            <Td>
              <Link
                as="button"
                :href="route('admin.cities.edit', city.slug)"
                :data="{
                  page: props.cities.current_page,
                  per_page: params.per_page,
                }"
