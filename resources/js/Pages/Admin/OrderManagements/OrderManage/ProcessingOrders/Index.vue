...
<template>
  <AdminDashboardLayout>
    <Head :title="__('PROCESSING_ORDERS')" />
    ...
    <div class="px-4 md:px-10 mx-auto w-full py-32">
      ...
      <div class="flex items-center justify-end mb-5">
        ...
        <!-- Perpage Select Box -->
        <div class="ml-5">
          <DashboardPerPageSelectBox href="admin.orders.processing.index" />
        </div>

        <!-- Filter By Date -->
        <DashboardFilterByCreatedDate href="admin.orders.processing.index" />
      </div>
        ...
        <tbody v-if="processingOrders.data.length">
          ...
          >
            ...
            <Td v-if="orderManageDetail">
              <div>
                <DetailButton
                  href="admin.orders.processing.show"
