...
const params = reactive({
  ...
  page: props.pendingProductReviews.current_page
    ? props.pendingProductReviews.current_page
    : 1,
  per_page: props.pendingProductReviews.per_page
    ? props.pendingProductReviews.per_page
    : 10,
  sort: "id",
  direction: "desc",
});
