  ...
  <div>
    ...
    >
      <div class="flex flex-col items-center">
        <img
          v-if="status === 503"
          src="../assets/images/503.jpg"
          class="h-[500px]"
        />
        <img
          v-if="status === 500"
          src="../assets/images/500.jpg"
          class="h-[500px]"
        />
        <img
          v-if="status === 429"
          src="../assets/images/429.jpg"
          class="h-[500px]"
        />
        <img
          v-if="status === 404"
        ...
        <Link
          as="button"
          :href="route('home')"
          class="text-sm font-semibold border-2 px-5 py-3 rounded-sm border-blue-700 text-blue-700 hover:text-white hover:bg-blue-700 transition-all animate-bounce"
        >
