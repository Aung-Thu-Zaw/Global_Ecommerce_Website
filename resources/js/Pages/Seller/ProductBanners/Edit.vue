...
// Product Banner Edit Form Data
const form = useForm({
  seller_id: usePage().props.auth.user ? usePage().props.auth.user.id : null,
  url: props.sellerProductBanner.url,
  image: props.sellerProductBanner.image,
  status: props.sellerProductBanner.status,
  captcha_token: null,
});
...
const handleEditProductBanner = async () => {
  ...
  form.post(
    route("seller.product-banners.update", {
      seller_product_banner: props.sellerProductBanner.id,
...
<template>
  <SellerDashboardLayout>
    <Head :title="__('EDIT_PRODUCT_BANNER')" />
