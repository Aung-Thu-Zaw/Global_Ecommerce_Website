...
import ProductReplyEditForm from "@/Components/Forms/ProductReplyEditForm.vue";
import { ref } from "vue";
...
<template>
  ...
  <div class="w-[95%] ml-auto">
    ...
    >
      ...
      <div v-if="isEditReplyFormVisible" class="w-full">
        <ProductReplyEditForm
          :paginateProductReview="paginateProductReview"
          @isVisible="isEditReplyFormVisible = false"
        />
      </div>
    </div>
  </div>
