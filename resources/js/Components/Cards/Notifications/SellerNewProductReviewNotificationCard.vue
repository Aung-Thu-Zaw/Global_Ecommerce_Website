...
const goToDetailPage = () => {
  router.get(
    route("seller.product-reviews.show", props.notification.data.review.id)
  );
};
...
<template>
  ...
  >
    <div
      class="flex-shrink-0 bg-fuchsia-300 text-fuchsia-700 ring-2 ring-fuchsia-500 w-10 h-10 rounded-md flex items-center justify-center p-3 font-bold"
    >
      <i
    ...
    <div class="w-full pl-3">
      ...
      <div
        ...
        :class="{
          'text-fuchsia-500': !notification.read_at,
          'text-gray-500': notification.read_at,
        }"
      >
        <i
