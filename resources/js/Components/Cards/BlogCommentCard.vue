  ...
  <div class="relative w-full">
    <div class="flex flex-col items-end w-full">
      <div class="flex items-start justify-between w-full mb-1">
        ...
        <div class="flex items-center">
          ...
          <button
            :id="'dropdownMenuIconButton' + blogComment.id"
            :data-dropdown-toggle="'dropdownDot' + blogComment.id"
        ...
        >
          <ul
            ...
            :aria-labelledby="'dropdownMenuIconButton' + blogComment.id"
          >
            <li>
              <button
            ...
            <li>
              <!-- v-if="
                 ...
                 ( blogComment.user_id === $page.props.auth.user?.id ||
                  blogComment.product.user_id === $page.props.auth.user?.id)
                " -->
              <button
                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white w-full text-left"
              >
    ...
    <div
      v-if="
        ...
        $page.props.auth.user &&
        blogPost.author_id === $page.props.auth.user.id
      "
    ...
    <div
      v-if="
        $page.props.auth.user &&
        $page.props.auth.user?.id === blogComment.user_id
      "
    ...
    <hr v-if="blogComment.blog_comment_reply" class="mt-5" />
  </div>
</template>
