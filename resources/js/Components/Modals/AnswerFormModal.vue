...
<template>
  ...
  >
    <button
      :data-modal-target="'answer-modal' + question.id"
      :data-modal-toggle="'answer-modal' + question.id"
    ...
    <div class="relative w-full max-w-3xl max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 w-full">
        <button
          ...
          :data-modal-hide="'answer-modal' + question.id"
        >
          <svg
            aria-hidden="true"
            class="w-5 h-5"
        ...
        <div class="px-6 py-6 lg:px-8">
          <form @submit.prevent="handleAskQuestion" class="space-y-3 mr-5">
            <textarea
              cols="30"
              rows="10"
