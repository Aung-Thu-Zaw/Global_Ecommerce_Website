...
const handleCreateShopReview = async () => {
  await recaptchaLoaded();
  form.captcha_token = await executeRecaptcha("create_shop_review");
  submit();
};

const submit = () => {
  form.post(route("shop.review.store"), {
    replace: true,
    preserveScroll: true,
...
<template>
  <div class="p-5">
    ...
    <form @submit.prevent="handleCreateShopReview">
      <div
