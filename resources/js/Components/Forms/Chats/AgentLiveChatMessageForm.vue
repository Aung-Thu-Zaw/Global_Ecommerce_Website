...
const form = useForm({
  ...
  agent_id: usePage().props.auth.user ? usePage().props.auth.user.id : null,
  user_id: null,
  ...
  >
    ...
    >
      ...
      <div class="w-full">
        <input
          type="text"
          class="bg-transparent w-full border-0 focus:ring-0 text-sm text-slate-700 py-2.5 border-b-2 focus:border-b-2 border-b-slate-300 hover:border-b-slate-300 focus:border-0"
          :placeholder="__('TYPE_A_MESSAGE')"
