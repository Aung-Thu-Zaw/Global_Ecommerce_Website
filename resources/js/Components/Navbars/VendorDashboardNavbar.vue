...
import NotificationDropdownForVendorDashboard from "@/Components/Dropdowns/NotificationDropdownForVendorDashboard.vue";
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <NotificationDropdownForVendorDashboard />
