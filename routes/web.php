...
Route::middleware(["auth","user.role:admin"])->group(function () {
    ...
    Route::post("/admin/managements/inactive-vendors/{id}/active", [AdminInactiveVendorController::class,"update"])->name("admin.vendors.inactive.update");
    ...
    Route::post("/admin/managements/active-vendors/{id}/inactive", [AdminActiveVendorController::class,"update"])->name("admin.vendors.active.update");
    Route::get("admin/managements/active-vendors/details/{id}", [AdminActiveVendorController::class,"show"])->name("admin.vendors.active.details");
});
